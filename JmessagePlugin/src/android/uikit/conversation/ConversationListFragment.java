...
public class ConversationListFragment extends BaseFragment {
    ...
    private static String TAG = "jmessage"; // ConversationListFragment.class.getSimpleName()
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRootView = layoutInflater.inflate(IdHelper.getLayout(mContext, "jmui_fragment_conv_list"), null, false); // (ViewGroup) getActivity().findViewById(R.id.main_view)
        ...
        mMenuView = getActivity().getLayoutInflater().inflate(IdHelper.getLayout(mContext, "jmui_drop_down_menu"), null);
        ...
        mMenuItemView = new MenuItemView(mContext, mMenuView);
    ...
    public void showMenuPopWindow() {
        ...
        if (mMenuPopWindow.isShowing()) {
            ...
            mMenuPopWindow.showAsDropDown(mRootView.findViewById(IdHelper.getViewID(mContext, "create_group_btn")), -10, -5);
    }
