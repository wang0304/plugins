...
public class MyTextMessage implements Serializable {
    ...
    public MyMsgContent content;
    public String serverMessageId;
    public String status;

    public static MyTextMessage instance;
    public static MyTextMessage getInstance(){
        if(instance == null){
            instance = new MyTextMessage();
        }
        return instance;
    }

    public MyTextMessage setMessage(String msgStr){
